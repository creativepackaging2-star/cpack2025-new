...
export default function ProductForm({ initialData }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 bg-white rounded-xl border border-slate-200 shadow-sm max-w-6xl mx-auto mb-10 overflow-hidden">
            <div className="bg-slate-900 px-4 md:px-8 py-4 flex justify-between items-center border-b border-slate-800">
