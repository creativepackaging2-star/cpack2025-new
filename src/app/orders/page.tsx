                ...
                <tr className="bg-slate-50/50">
                    <td colSpan={7} className="px-12 py-8">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 animate-in fade-in slide-in-from-top-2">
                            ...
                            {/* Second Row: Technical Specs spanning full width */}
                            <div className="md:col-span-12 pt-6 border-t border-slate-200 mt-4">
                                <div className="space-y-6">
                                    <div className="flex items-center gap-3">
                                        <div className="h-[1px] flex-1 bg-slate-200"></div>
                                        <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest whitespace-nowrap">Technical Specifications & Material Detail</h4>
                                        <div className="h-[1px] flex-1 bg-slate-200"></div>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm text-xs space-y-3 lg:col-span-2">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-3">
                                                ...
                                                <div className="flex justify-between border-b pb-1.5"><span className="text-slate-500">Dim:</span> <span className="font-mono font-bold text-indigo-600 font-bold">{order.dimension || '-'}</span></div>
                                            </div>
                                        </div>

                                        <div className="flex flex-col gap-4">
                                            <div className="bg-indigo-50 p-5 rounded-xl border border-indigo-200 h-full">
                                                <div className="text-[9px] font-bold text-indigo-600 uppercase tracking-widest mb-2 text-center">Full Description</div>
                                                <div className="text-xs text-slate-700 font-mono leading-relaxed line-clamp-6">{order.specs || 'No extended specifications provided.'}</div>
                                            </div>
                                            <div className="flex items-center gap-4 justify-center bg-white border border-slate-200 rounded-xl p-3 shadow-sm">
