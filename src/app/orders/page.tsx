            ...
            <PageHeader
                ...
                actions={
                    <div className="flex flex-wrap items-center justify-end gap-2 md:gap-3 w-full md:w-auto">
                        ...
                        <div className="flex items-center bg-slate-800 border border-slate-700 rounded-lg p-1 shadow-sm gap-0.5 md:gap-1">
                            <Link
                                href="/orders/summary/printer"
                                title="Printer Summary"
                                className="flex items-center gap-1 px-2 md:px-3 py-1 text-[11px] md:text-[13px] font-bold text-slate-300 hover:bg-slate-700 hover:text-indigo-400 rounded-md transition-all"
                            >
                                <Printer className="w-3 md:w-3.5 h-3 md:h-3.5" />
                                <span className="hidden sm:inline">Printers</span>
                                <span className="sm:hidden">Print</span>
                            </Link>
                            <div className="w-[1px] h-3 md:h-4 bg-slate-700"></div>
                            <Link
                                href="/orders/summary/paper"
                                title="Paper Order Summary"
                                className="flex items-center gap-1 px-2 md:px-3 py-1 text-[11px] md:text-[13px] font-bold text-slate-300 hover:bg-slate-700 hover:text-emerald-400 rounded-md transition-all"
                            >
                            ...
                            <Link
                                ...
                                className="flex items-center gap-1 px-2 md:px-3 py-1 text-[11px] md:text-[13px] font-bold text-slate-300 hover:bg-slate-700 hover:text-rose-400 rounded-md transition-all"
                            >
                                <Palette className="w-3 md:w-3.5 h-3 md:h-3.5" />
                                <span className="hidden sm:inline">Punching</span>
                                <span className="sm:hidden">Punch</span>
                            </Link>
                        </div>
                        <div className="flex items-center gap-1 md:gap-2">
                            <label className="flex items-center gap-1.5 text-[11px] md:text-[13px] text-slate-300 bg-slate-800 px-2 md:px-3 py-1.5 md:py-2 rounded-lg border border-slate-700 cursor-pointer hover:bg-slate-700 select-none">
                                <input
                                    type="checkbox"
                                    checked={showCompleted}
                                    onChange={e => handleToggleCompleted(e.target.checked)}
                                    className="w-3 h-3 md:w-4 md:h-4 rounded text-indigo-600 focus:ring-indigo-500"
                                />
                                Done
                            </label>
                            <label className="flex items-center gap-1.5 text-[11px] md:text-[13px] text-slate-300 bg-slate-800 px-2 md:px-3 py-1.5 md:py-2 rounded-lg border border-slate-700 cursor-pointer hover:bg-slate-700 select-none">
                        ...
                        <Link href="/orders/new" className="inline-flex items-center justify-center rounded-lg bg-indigo-600 px-3 md:px-4 py-1.5 md:py-2 text-[11px] md:text-sm font-bold text-white hover:bg-indigo-500 transition-colors shadow-sm whitespace-nowrap">
                            <Plus className="mr-1 md:mr-2 h-3.5 md:h-4 w-3.5 md:w-4" />
                            New Order
                        </Link>
                    </div>
                }
